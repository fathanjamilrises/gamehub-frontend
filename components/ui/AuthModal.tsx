    ...
    <AnimatePresence>
      {isOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          {/* Modal */}
          <motion.div
            className="relative bg-white rounded-lg border-2 border-gray-900 w-full max-w-md mx-4 nb-shadow-lg overflow-hidden flex flex-col max-h-[calc(100vh-2rem)]"
              ...
              <AnimatePresence mode="wait">
                {error && (
                  <motion.div
                    ...
                    className="mb-4 p-3 bg-red-50 border-2 border-red-400 rounded-lg text-red-600 text-sm font-medium overflow-hidden"
                  >
                    {error}
                  </motion.div>
                )}
              ...
              <AnimatePresence mode="wait">
                {success && (
                  <motion.div
                    ...
                    exit={{ opacity: 0, y: -8, height: 0 }}
                    transition={{ duration: 0.25, ease: [0.22, 1, 0.36, 1] as const }}
                    className="mb-4 p-3 bg-green-50 border-2 border-green-400 rounded-lg text-green-700 text-sm font-medium overflow-hidden"
                  >
                    {success}
                  </motion.div>
                )}
                    ...
                    <form onSubmit={handleLogin}>
                      ...
                      <div className="space-y-4">
                        ...
                        <motion.button
                          type="submit"
                          disabled={loading}
                          className="w-full bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-bold py-3.5 rounded-lg border-2 border-gray-900 transition-colors text-sm mt-2 disabled:cursor-not-allowed nb-shadow-sm"
